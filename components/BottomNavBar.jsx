        ...
        >
          {BOTTOM_TABS.map((tab) => {
            ...
            const tabColor = isActive
              ...
              : isDarkMode
              ? Palette.dark.onSurfaceVariant
              : Palette.light.onSurfaceVariant
            return (
              <Pressable
                key={tab.id}
              ...
              >
                <Feather name={tab.icon} size={24} color={tabColor} style={{ marginBottom: 4 }} />
                <Text
                  style={{
                    fontSize: 11,
                    fontFamily: isActive ? Fonts.inter.bold : Fonts.inter.semibold,
                    paddingLeft: 6,
                    color: tabColor,
                  }}
                >
